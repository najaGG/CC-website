...
function Menu() {
  return (
    <Navbar bg="black" variant="dark" expand="lg" className="navbar-dark">
      <Navbar.Toggle aria-controls="basic-navbar-nav">
        <FaBars size={24} /> {/* ใช้ไอคอน hamburger */}
      </Navbar.Toggle>
      <Navbar.Collapse id="basic-navbar-nav">
        <Nav className="ml-auto">
          <NavDropdown title={<FaBars size={24} />} id="basic-nav-dropdown">
            <NavDropdown.Item as={Link} to="/">ACTIVITY & INFORMATION</NavDropdown.Item>
